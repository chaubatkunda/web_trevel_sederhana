    ...
    <div class="container">
        ...
        <div class="row align-items-center text-center text-md-left">
            ...
            <div class="col-md-6 col-lg-7 col-xl-6 offset-xl-1">
                <img class="img-fluid" src="<?php echo base_url('public/assets/fron/'); ?>img/home/hero-img.png" alt="">
            </div>
        </div>
    </div>
</section>
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-7 col-md-6 mb-4 mb-md-0">
                <div class="about-img">
                    <img class="img-fluid" src="<?php echo base_url('public/assets/fron/'); ?>img/home/about-img.png" alt="">
                </div>
            </div>
                ...
                <div class="row">
                    <div class="col-md-3 col-lg-2 align-self-center">
                        <div class="testimonial__img">
                            <img class="card-img rounded-0" src="<?php echo base_url('public/assets/fron/'); ?>img/testimonial/t-slider1.png" alt="">
                        </div>
                    </div>
...
<section class="section-padding bg-gray">
    <div class="container">
        ...
        <div class="row">
            <div class="col-md-6 col-lg-4 mb-4 mb-lg-0">
                <div class="card-blog">
                    <img class="card-img rounded-0" src="<?php echo base_url('public/assets/fron/'); ?>img/blog/blog-1.png" alt="">
            ...
            <div class="col-md-6 col-lg-4 mb-4 mb-lg-0">
                <div class="card-blog">
                    <img class="card-img rounded-0" src="<?php echo base_url('public/assets/fron/'); ?>img/blog/blog-2.png" alt="">
                    <div class="card-blog-body">
                        <a href="#">
                            <h4>Forest responds to consultation smoking in al fresco.</h4>
                        </a>
            ...
            <div class="col-md-6 col-lg-4 mb-4 mb-lg-0">
                <div class="card-blog">
                    <img class="card-img rounded-0" src="<?php echo base_url('public/assets/fron/'); ?>img/blog/blog-3.png" alt="">
                    <div class="card-blog-body">
                        <a href="#">
                            <h4>Forest responds to consultation smoking in al fresco.</h4>
                        </a>
