                    ...
                    <form action="" method="post" enctype="multipart/form-data" role="form">
                        <div class="card-body">
                            <div class="form-group">
                                ...
                                <input type="text" name="bank" class="form-control" id="bank" placeholder="BANK">
                                <small class="text-danger"><?php echo form_error('bank'); ?></small>
                            </div>
                            <div class="form-group">
                                <label for="rek">Rekening</label>
                                <input type="text" name="rek" class="form-control" id="rek" placeholder="Rekening">
                                <small class="text-danger"><?php echo form_error('rek'); ?></small>
                            </div>
                            <div class="form-group">
                                <label for="pemilik">Pemilik</label>
                                <input type="text" name="pemilik" class="form-control" id="pemilik" placeholder="Pemilik">
